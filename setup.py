...
Info
    Defines setup for scaraemu package.
'''
...
setup(
    ...
    url='https://github.com/vroncevic/scaraemu',
    license='GNU General Public License (GPL)',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='scara, emulator, visualizer, kinematics, robotics, serial-bridge, simulation',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    install_requires=['ats-utilities', 'pyserial'],
    package_data={'scaraemu': find_package_data('scaraemu')},
    entry_points={
        'console_scripts': [
            'scaraemu=main:main'
        ]
