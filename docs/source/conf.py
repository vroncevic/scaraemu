...
htmlhelp_basename: str = 'scaraemudoc'
latex_elements: dict[object, object] = {}
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'scaraemu.tex', 'scaraemu Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'scaraemu', 'scaraemu Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'scaraemu', 'scaraemu Documentation', author, 'scaraemu',
    'SCARA Robot Python Emulator and 2D/3D Kinematic Visualizer.', 'Miscellaneous'
)]
