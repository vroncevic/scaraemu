...
from scaraemu.core.model.simulation.telemetry import Telemetry
...
from scaraemu.core.service.simulation.motion_trajectory_queue import MotionTrajectoryQueue
...
class EmulatorService:
    '''
        ...
        It defines:
            ...
            :attributes:
                ...
                | _queue - MotionTrajectoryQueue managing waypoints and trail buffer.
    ...
    _queue: Final[MotionTrajectoryQueue]
    ...
    def __init__(
        ...
        self._queue = MotionTrajectoryQueue(
            initial_x=self._current_pose.x,
            initial_y=self._current_pose.y
        )
    ...
    def enqueue_trajectory(self, poses: Sequence[ScaraPose]) -> int:
        ...
        last_p: ScaraPose = self._queue.get_last_pose(fallback=self._current_pose)
        count: int = 0
    ...
    def step_simulation(self) -> bool:
        ...
        if (
            ...
            or self._queue.get_queue_depth() == 0
        ...
        if joints.reachable:
            ...
            self._current_joints = joints
            self._queue.append_trail(next_pose.x, next_pose.y)
            return True
    ...
    def clear_queue(self) -> None:
        ...
        '''
        self._active_target = None
        self._queue.clear(current_pose=self._current_pose)
    ...
    def get_simulation_state(self) -> SimulationState:
        '''
            ...
            :exceptions: None.
        '''
        queue_depth: int = self._queue.get_queue_depth()
        target = self._active_target if self._is_hardware_connected else (
            self._queue.get_peek_target()
        )
        return SimulationState(
            is_animating=queue_depth > 0 and not self._is_hardware_connected,
            queue_depth=queue_depth,
            trail_points=self._queue.get_trail_points(),
