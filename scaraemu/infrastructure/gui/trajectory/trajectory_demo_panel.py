...
from scaraemu.infrastructure.gui.trajectory.script_loader_section import (
    ScriptLoaderSection,
)
...
class TrajectoryDemoPanel(LabelFrame):
    '''
        ...
        It defines:
            ...
            :attributes:
                ...
                | _script_section - ScriptLoaderSection sub-panel.
            ...
            :methods:
                ...
                | _trigger - Dispatches demo preset selection.
                | _clear - Dispatches clear queue callback.
    '''

    _lbl_queue: Label
    _script_section: Final[ScriptLoaderSection]
    ...
    def __init__(
        ...
        self._script_section = ScriptLoaderSection(self, on_load_script=on_load_script)
        self._script_section.pack(fill=X, pady=(4, 6))
    ...
    def update_queue_depth(self, count: int) -> None:
        ...
        color: str = ThemeManager.ACCENT_GREEN if count == 0 else ThemeManager.ACCENT_ORANGE
