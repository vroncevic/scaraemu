...
Info
    CLIBundleOptions TypedDict definition.
'''
...
class CLIBundleOptions(TypedDict, total=False):
    '''
        CLI bundle options specification.
        ...
        It defines:
            ...
            :attributes:
                ...
                | gui - The GUI presentation interface instance.
    '''
