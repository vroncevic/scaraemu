...
Info
    Validator for CLI bundle dependencies.
'''
...
class CLIBundleDependenciesValidator:
    ...
    def validate(cls, dependencies: CLIBundleDependencies) -> None:
        '''
            ...
            :exceptions:
                | ATSValueError: The CLI bundle dependencies must be provided.
                | ATSTypeError: The CLI bundle dependencies must be a Mapping and match expected types.
        '''
        ctx: str = 'cli_bundle_dependencies_validator::validate(...)'
        msg_deps_none: str = 'the CLI bundle dependencies must be provided'
        msg_deps_istype: str = 'the CLI bundle dependencies must be a Mapping'
    ...
    def is_valid(cls, dependencies: CLIBundleDependencies) -> bool:
        '''
            ...
            :param dependencies: The CLI bundle dependencies to check.
